      ...
      <div className="h-screen bg-background flex flex-col">
          ...
          <header className="bg-gradient-panel px-4 sm:px-6 py-3 sm:py-4">
            <div className="flex items-center justify-between">
              ...
              <div>
                <p className="text-xs sm:text-sm text-muted-foreground hidden sm:block max-w-[280px]">Transform Natural Language Tasks into Structured Given-When-Then Statements</p>
              </div>
              </div>
